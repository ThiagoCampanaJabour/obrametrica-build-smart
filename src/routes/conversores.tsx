...
export const Route = createFileRoute("/conversores")({
  head: () => pageHead({
    ...
    description: "Conversores técnicos de unidades para engenharia e construção: m² para hectare, cm para polegada e litros para m³.",
    path: PATH,
    breadcrumbs: CRUMBS,
  }),
...
const converters = [
  { to: "/conversor-m2-para-hectare" as const, icon: Square, title: "m² para Hectare", desc: "Converte metros quadrados para hectares." },
  { to: "/conversor-cm-para-polegada" as const, icon: Ruler, title: "cm para Polegada", desc: "Converte centímetros para polegadas." },
  { to: "/conversor-litros-para-m3" as const, icon: Droplets, title: "Litros para m³", desc: "Converte litros para metros cúbicos." },
];
