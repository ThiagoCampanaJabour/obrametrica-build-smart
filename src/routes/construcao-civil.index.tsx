...
import { Brick, Boxes, LayoutGrid, Paintbrush, Layers, ArrowRight } from "lucide-react";
...
const calcs = [
  { to: "/construcao-civil/tijolos" as const, icon: Brick, title: "Calculadora de Tijolos", desc: "Quantidade de tijolos por área e tipo." },
