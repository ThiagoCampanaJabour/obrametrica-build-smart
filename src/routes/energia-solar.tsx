...
export const Route = createFileRoute("/energia-solar")({
  head: () => pageHead({
    ...
    description: "Calculadoras de energia solar: dimensionamento de placas e estimativa de economia mensal, anual e em 10 anos.",
    path: PATH,
    breadcrumbs: CRUMBS,
  }),
...
const tools = [
  { to: "/quantas-placas-solares-preciso" as const, icon: Sun, title: "Quantas Placas Solares Preciso", desc: "Dimensione o sistema fotovoltaico a partir do consumo mensal em kWh." },
  { to: "/economia-energia-solar" as const, icon: TrendingUp, title: "Economia com Energia Solar", desc: "Estime a economia no mês, no ano e em 10 anos." },
];
